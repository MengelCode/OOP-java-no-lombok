...
public class Level1 extends java.util.TimerTask {
    Level1(){
    ...
    public void run(){
        if(MissileExchange.numberOfUFOSOnScreen <= UFO_SCREEN_LIMIT){
            if(MissileExchange.ufosGeneratedThisLevel + 3 <= LEVEL_ONE_UFOS_TO_DEFEAT) {
            ...
            } else if(MissileExchange.ufosGeneratedThisLevel + 2 <= LEVEL_ONE_UFOS_TO_DEFEAT) {
				...
				MissileExchange.ufos.add(du1);
				MissileExchange.ufos.add(du2);
            } else if(MissileExchange.ufosGeneratedThisLevel + 1 <= LEVEL_ONE_UFOS_TO_DEFEAT) {
        ...
        if(MissileExchange.ufosDestroyedThisLevel >= LEVEL_ONE_UFOS_TO_DEFEAT) {
    ...
    public static final int LEVEL_ONE_UFOS_TO_DEFEAT = 9;
}   //end class Level1